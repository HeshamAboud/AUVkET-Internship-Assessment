...
abstract class NetworkExceptions with _$NetworkExceptions {
  ...
  static NetworkExceptions handleResponse({required dynamic response}) {
    Failure listOfErrors = Failure.fromJson(response);

    String allErrors = listOfErrors.message!;

    int statusCode = listOfErrors.code ?? 0;
        ...
        if (error is DioException) {
          switch (error.type) {
            ...
            case DioExceptionType.badResponse:
              networkExceptions =
                  NetworkExceptions.handleResponse(response: error.response);
              break;
